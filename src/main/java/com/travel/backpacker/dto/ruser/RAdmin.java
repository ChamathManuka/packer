...
public class RAdmin implements RUser
{
	@Min(value = 0, message = "Id should be provided")
	private long id;
	...
	public RAdmin(long id, String username, String firstname, String lastname, @NotNull(message = "Password should not be empty") char[] password, String email, String phone, User.Gender gender, String platform, RAddress rAddress )
	{
		this.id = id;
