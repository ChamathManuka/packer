...
import com.travel.backpacker.interceptors.JwtImplInterceptor;
...
{
	private final JwtImplInterceptor jwtInterceptor;

	@Autowired
	public UserLoginAction( JwtImplInterceptor jwtInterceptor )
	{
